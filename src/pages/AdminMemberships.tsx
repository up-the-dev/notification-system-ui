...
import { UserGroupIcon, MagnifyingGlassIcon, PencilIcon, TrashIcon, PlusIcon } from '@heroicons/react/24/outline';
      ...
      >
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-3xl font-bold text-white">Memberships Management</h1>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-white/5 border-b border-white/10">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">SMS Quota</th>
              ...
              <tbody className="divide-y divide-white/10">
                {filteredMemberships.map((membership) => (
                  <tr key={membership.id} className="hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4 text-white font-medium">{membership.name}</td>
                    <td className="px-6 py-4 text-gray-300">{membership.sms_quota.toLocaleString()}</td>
                    <td className="px-6 py-4 text-gray-300">${membership.price.toFixed(2)}</td>
                    <td className="px-6 py-4 text-gray-300">{membership.duration_days} days</td>
