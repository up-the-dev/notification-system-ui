...
const CreateMembership: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(
        error.message || "Failed to create membership. Please try again."
      );
    }
    setLoading(false);
  };
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <p className="text-gray-400 mb-6">
                  Select the notification channels you want to add (you can
                  select both)
                </p>
            ...
            {step === 2 && (
              ...
              >
                ...
                <p className="text-gray-400 mb-6">
                  Choose the plans that best fit your needs
                </p>
